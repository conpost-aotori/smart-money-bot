...
class DiscordClient:
    ...
    def send(
        ...
        *,
        ...
        ``username`` overrides the webhook's display name so multiple bots can
        share one webhook URL (e.g. BTC IV bot + Smart Money bot in the same
        Discord channel, distinguishable by name).
        """
